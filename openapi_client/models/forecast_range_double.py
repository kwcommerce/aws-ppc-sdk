...
class ForecastRangeDouble(BaseModel):
    ...
    A range of value.
    """ # noqa: E501
    min: Optional[Any] = Field(default=None, description="Lower bound.")
    mean: Optional[Any] = Field(default=None, description="Geometric mean of the upper and lower bounds.")
    max: Optional[Any] = Field(default=None, description="Upper bound.")
    __properties: ClassVar[List[str]] = ["min", "mean", "max"]
