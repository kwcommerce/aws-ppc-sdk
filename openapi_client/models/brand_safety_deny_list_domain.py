...
class BrandSafetyDenyListDomain(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(strict=True, max_length=250)] = Field(description="The website or app identifier. This can be in the form of full domain (eg. 'example.com' or 'example.net'), or mobile app identifier (eg. 'com.example.app' for Android apps or '1234567890' for iOS apps) ")
