...
class SDThemeRecommendationsV34(BaseModel):
    ...
    """ # noqa: E501
    themes: Optional[SDThemeRecommendationsV34Themes] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "themes": SDThemeRecommendationsV34Themes.from_dict(obj["themes"]) if obj.get("themes") is not None else None
        })
        return _obj
