...
class OptimizationRuleAssociationResponse(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="The HTTP status code of the response.")
    responses: Optional[Annotated[List[SingleOptimizationRuleAssociationResponse], Field(max_length=1)]] = Field(default=None, description="An array of response objects. Each response object has code, details and optimizationRuleId.")
    __properties: ClassVar[List[str]] = ["code", "responses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "responses": [SingleOptimizationRuleAssociationResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
