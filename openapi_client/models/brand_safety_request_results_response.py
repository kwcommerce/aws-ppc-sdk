...
class BrandSafetyRequestResultsResponse(BaseModel):
    ...
    """ # noqa: E501
    results: Optional[List[BrandSafetyRequestResult]] = Field(default=None, description="A list of results for the given requestId")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [BrandSafetyRequestResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
