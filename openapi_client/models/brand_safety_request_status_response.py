...
class BrandSafetyRequestStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    request_status: Optional[BrandSafetyRequestStatus] = Field(default=None, alias="requestStatus")
    __properties: ClassVar[List[str]] = ["requestStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requestStatus": BrandSafetyRequestStatus.from_dict(obj["requestStatus"]) if obj.get("requestStatus") is not None else None
        })
        return _obj
