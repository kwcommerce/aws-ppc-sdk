...
class CreateAdGroup(BaseModel):
    ...
    CreateAdGroup
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the ad group.")
    ...
    state: StrictStr = Field(description="The state of the ad group.")
    creative_type: Optional[CreativeType] = Field(default=None, alias="creativeType")
    __properties: ClassVar[List[str]] = ["name", "campaignId", "defaultBid", "bidOptimization", "state", "creativeType"]
