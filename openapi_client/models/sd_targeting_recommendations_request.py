...
class SDTargetingRecommendationsRequest(BaseModel):
    ...
    type_filter: Annotated[List[SDRecommendationType], Field(min_length=1, max_length=1)] = Field(description="A filter to indicate which types of recommendations to request.", alias="typeFilter")
