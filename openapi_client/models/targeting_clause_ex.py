...
class TargetingClauseEx(BaseModel):
    ...
    campaign_id: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="campaignId")
    state: Optional[StrictStr] = None
    expression_type: Optional[StrictStr] = Field(default=None, alias="expressionType")
    bid: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="If a value for `bid` is specified, it overrides the current adGroup bid. When using vcpm costType. $1 is the minimum bid for vCPM. Note that this field is ignored for negative targeting clauses.")
    ...
    __properties: ClassVar[List[str]] = ["targetId", "adGroupId", "campaignId", "state", "expressionType", "bid", "expression", "resolvedExpression", "servingStatus", "creationDate", "lastUpdatedDate"]
