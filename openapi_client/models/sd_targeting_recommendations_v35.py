...
class SDTargetingRecommendationsV35(BaseModel):
    ...
    content_categories: Optional[Annotated[List[SDContentCategoryRecommendations], Field(min_length=0, max_length=1000)]] = Field(default=None, description="List of recommended entertainment targets", alias="contentCategories")
    themes: Optional[SDThemeRecommendationsV34] = None
    __properties: ClassVar[List[str]] = ["products", "categories", "audiences", "contentCategories", "themes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in content_categories (list)
        _items = []
        if self.content_categories:
            for _item in self.content_categories:
                if _item:
                    _items.append(_item.to_dict())
            _dict['contentCategories'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contentCategories": [SDContentCategoryRecommendations.from_dict(_item) for _item in obj["contentCategories"]] if obj.get("contentCategories") is not None else None,
