...
class BackgroundCreativeProperties(BaseModel):
    ...
    """ # noqa: E501
    backgrounds: Optional[List[Background]] = Field(default=None, description="An optional collection of backgrounds which are displayed on the ad.")
    __properties: ClassVar[List[str]] = ["backgrounds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "backgrounds": [Background.from_dict(_item) for _item in obj["backgrounds"]] if obj.get("backgrounds") is not None else None
        })
        return _obj
