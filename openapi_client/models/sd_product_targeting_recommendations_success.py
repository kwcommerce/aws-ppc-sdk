...
class SDProductTargetingRecommendationsSuccess(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="HTTP status code 200 indicating a successful response for product recomendations.")
    ...
    __properties: ClassVar[List[str]] = ["code", "name", "recommendations"]
