...
class CurvePointRangedValue(BaseModel):
    ...
    A ranged value.
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, description="KPI label.")
    ...
    def label_validate_enum(cls, value):
        ...
        if value not in set(['CLICKS', 'REACH']):
            raise ValueError("must be one of enum values ('CLICKS', 'REACH')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "label": obj.get("label"),
            "value": ForecastRangeDouble.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
