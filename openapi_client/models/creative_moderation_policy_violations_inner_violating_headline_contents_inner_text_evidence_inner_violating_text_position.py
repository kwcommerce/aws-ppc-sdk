...
class CreativeModerationPolicyViolationsInnerViolatingHeadlineContentsInnerTextEvidenceInnerViolatingTextPosition(BaseModel):
    """
    CreativeModerationPolicyViolationsInnerViolatingHeadlineContentsInnerTextEvidenceInnerViolatingTextPosition
    """ # noqa: E501
    start: Optional[StrictInt] = Field(default=None, description="Zero-based index into the text in reviewedText where the text specified in violatingText starts")
    end: Optional[StrictInt] = Field(default=None, description="Zero-based index into the text in reviewedText where the text specified in violatingText ends")
