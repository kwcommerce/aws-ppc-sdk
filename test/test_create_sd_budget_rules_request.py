...
class TestCreateSDBudgetRulesRequest(unittest.TestCase):
    """CreateSDBudgetRulesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSDBudgetRulesRequest:
        """Test CreateSDBudgetRulesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSDBudgetRulesRequest`
        """
        model = CreateSDBudgetRulesRequest()
        if include_optional:
            return CreateSDBudgetRulesRequest(
                budget_rules_details = [
                    openapi_client.models.sd_budget_rule_details.SDBudgetRuleDetails(
    ...
    def testCreateSDBudgetRulesRequest(self):
        """Test CreateSDBudgetRulesRequest"""
