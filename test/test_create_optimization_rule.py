...
class TestCreateOptimizationRule(unittest.TestCase):
    """CreateOptimizationRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOptimizationRule:
        """Test CreateOptimizationRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOptimizationRule`
        """
        model = CreateOptimizationRule()
        if include_optional:
    ...
    def testCreateOptimizationRule(self):
        """Test CreateOptimizationRule"""
