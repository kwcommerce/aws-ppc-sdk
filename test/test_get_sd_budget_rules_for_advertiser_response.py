...
class TestGetSDBudgetRulesForAdvertiserResponse(unittest.TestCase):
    """GetSDBudgetRulesForAdvertiserResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSDBudgetRulesForAdvertiserResponse:
        """Test GetSDBudgetRulesForAdvertiserResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSDBudgetRulesForAdvertiserResponse`
        """
        model = GetSDBudgetRulesForAdvertiserResponse()
        if include_optional:
            return GetSDBudgetRulesForAdvertiserResponse(
                budget_rules_for_advertiser_response = [
    ...
    def testGetSDBudgetRulesForAdvertiserResponse(self):
        """Test GetSDBudgetRulesForAdvertiserResponse"""
