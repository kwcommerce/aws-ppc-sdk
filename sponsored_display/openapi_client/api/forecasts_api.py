...
class ForecastsApi:
    ...
    def create_sd_forecast(
        ...
        sd_forecast_request: Optional[SDForecastRequest] = None,
        ...
        :param sd_forecast_request:
        :type sd_forecast_request: SDForecastRequest
        ...
        _param = self._create_sd_forecast_serialize(
            ...
            sd_forecast_request=sd_forecast_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SDForecastResponse",
            '400': "SDForecastErrorResponse",
            '401': "SDForecastErrorResponse",
            '403': "SDForecastErrorResponse",
            '429': "SDForecastErrorResponse",
            '500': "SDForecastErrorResponse",
        }
    ...
    @validate_call
    def create_sd_forecast_with_http_info(
        self,
        amazon_advertising_api_client_id: Annotated[StrictStr, Field(description="The identifier of a client associated with a \"Login with Amazon\" account.")],
        amazon_advertising_api_scope: Annotated[StrictStr, Field(description="The identifier of a profile associated with the advertiser account. Use `GET` method on Profiles resource to list profiles associated with the access token passed in the HTTP Authorization header.")],
        sd_forecast_request: Optional[SDForecastRequest] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SDForecastResponse]:
        """Return forecasts for an ad group that may or may not exist.
    ...
    @validate_call
    def create_sd_forecast_without_preload_content(
        self,
        amazon_advertising_api_client_id: Annotated[StrictStr, Field(description="The identifier of a client associated with a \"Login with Amazon\" account.")],
        amazon_advertising_api_scope: Annotated[StrictStr, Field(description="The identifier of a profile associated with the advertiser account. Use `GET` method on Profiles resource to list profiles associated with the access token passed in the HTTP Authorization header.")],
        sd_forecast_request: Optional[SDForecastRequest] = None,
    ...
    def _create_sd_forecast_serialize(
        self,
        ...
        if sd_forecast_request is not None:
            _body_params = sd_forecast_request
