...
class SDTargetingRecommendationsV32(BaseModel):
    ...
    themes: Optional[SDThemeRecommendationsThemes] = None
    __properties: ClassVar[List[str]] = ["products", "categories", "themes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "themes": SDThemeRecommendationsThemes.from_dict(obj["themes"]) if obj.get("themes") is not None else None
        })
        return _obj
