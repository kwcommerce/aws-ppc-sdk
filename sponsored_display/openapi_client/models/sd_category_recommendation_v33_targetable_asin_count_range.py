...
class SDCategoryRecommendationV33TargetableAsinCountRange(BaseModel):
    ...
    """ # noqa: E501
    range_lower: Optional[StrictInt] = Field(default=None, alias="rangeLower")
    range_upper: Optional[StrictInt] = Field(default=None, alias="rangeUpper")
    __properties: ClassVar[List[str]] = ["rangeLower", "rangeUpper"]
