...
class SDAudienceCategoryRecommendations(BaseModel):
    ...
    audiences: Optional[Annotated[List[SDAudienceRecommendation], Field(min_length=0, max_length=1000)]] = Field(default=None, description="List of recommended standard Amazon audience targets")
    __properties: ClassVar[List[str]] = ["category", "audiences"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "audiences": [SDAudienceRecommendation.from_dict(_item) for _item in obj["audiences"]] if obj.get("audiences") is not None else None
        })
        return _obj
