...
class SDTargetingPredicateBaseV31(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['asinCategorySameAs', 'asinBrandSameAs', 'asinPriceBetween', 'asinPriceGreaterThan', 'asinPriceLessThan', 'asinReviewRatingLessThan', 'asinReviewRatingGreaterThan', 'asinReviewRatingBetween', 'similarProduct', 'relatedProduct', 'exactProduct', 'asinIsPrimeShippingEligible', 'asinAgeRangeSameAs', 'asinGenreSameAs', 'audienceSameAs', 'lookback']):
