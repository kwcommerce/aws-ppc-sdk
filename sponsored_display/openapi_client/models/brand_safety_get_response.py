...
class BrandSafetyGetResponse(BaseModel):
    ...
    domains: Optional[List[BrandSafetyDenyListProcessedDomain]] = Field(default=None, description="List of Brand Safety Deny List Domains")
    __properties: ClassVar[List[str]] = ["pagination", "domains"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pagination": BrandSafetyGetResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None,
            "domains": [BrandSafetyDenyListProcessedDomain.from_dict(_item) for _item in obj["domains"]] if obj.get("domains") is not None else None
        })
        return _obj
