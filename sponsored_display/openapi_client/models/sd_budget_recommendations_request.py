...
class SDBudgetRecommendationsRequest(BaseModel):
    ...
    """ # noqa: E501
    campaign_ids: Annotated[List[StrictStr], Field(min_length=1, max_length=100)] = Field(description="A list of campaign ids for which to get budget recommendations and missed opportunities.", alias="campaignIds")
