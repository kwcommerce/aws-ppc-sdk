...
class SDBudgetRecommendationError(BaseModel):
    ...
    code: StrictStr = Field(description="The HTTP status code of the response.")
    details: StrictStr = Field(description="A human-readable description of the response.")
    __properties: ClassVar[List[str]] = ["index", "campaignId", "code", "details"]
