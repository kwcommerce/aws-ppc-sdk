...
class CallToAction(BaseModel):
    ...
    """ # noqa: E501
    call_to_action_type: Optional[CallToActionType] = Field(default=None, alias="callToActionType")
    properties: Optional[CallToActionProperties] = None
    __properties: ClassVar[List[str]] = ["callToActionType", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "callToActionType": obj.get("callToActionType"),
            "properties": CallToActionProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
