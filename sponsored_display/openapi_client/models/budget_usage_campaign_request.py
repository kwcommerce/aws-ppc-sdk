...
class BudgetUsageCampaignRequest(BaseModel):
    ...
    """ # noqa: E501
    campaign_ids: Optional[Annotated[List[StrictStr], Field(min_length=1, max_length=100)]] = Field(default=None, description="A list of campaign IDs", alias="campaignIds")
