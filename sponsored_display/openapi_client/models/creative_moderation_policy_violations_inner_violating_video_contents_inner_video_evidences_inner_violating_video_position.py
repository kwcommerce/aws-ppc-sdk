...
class CreativeModerationPolicyViolationsInnerViolatingVideoContentsInnerVideoEvidencesInnerViolatingVideoPosition(BaseModel):
    """
    CreativeModerationPolicyViolationsInnerViolatingVideoContentsInnerVideoEvidencesInnerViolatingVideoPosition
    """ # noqa: E501
    start: Optional[StrictInt] = Field(default=None, description="Time at which policy violation within video asset starts.")
    end: Optional[StrictInt] = Field(default=None, description="Time at which policy violation within the video asset ends.")
