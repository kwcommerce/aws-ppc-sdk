...
class TestSDBudgetRule(unittest.TestCase):
    """SDBudgetRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SDBudgetRule:
        """Test SDBudgetRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SDBudgetRule`
        """
        model = SDBudgetRule()
        if include_optional:
            return SDBudgetRule(
