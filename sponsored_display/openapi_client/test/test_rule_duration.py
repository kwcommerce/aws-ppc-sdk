...
class TestRuleDuration(unittest.TestCase):
    """RuleDuration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RuleDuration:
        """Test RuleDuration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RuleDuration`
        """
        model = RuleDuration()
        if include_optional:
            return RuleDuration(
