...
class TestGetSDBudgetRuleResponse(unittest.TestCase):
    """GetSDBudgetRuleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSDBudgetRuleResponse:
        """Test GetSDBudgetRuleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSDBudgetRuleResponse`
        """
        model = GetSDBudgetRuleResponse()
        if include_optional:
            return GetSDBudgetRuleResponse(
                budget_rule = openapi_client.models.sd_budget_rule.SDBudgetRule(
                    rule_state = 'ACTIVE', 
    ...
    def testGetSDBudgetRuleResponse(self):
        """Test GetSDBudgetRuleResponse"""
