...
class TestSDTargetingRecommendationsRequestV32(unittest.TestCase):
    """SDTargetingRecommendationsRequestV32 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SDTargetingRecommendationsRequestV32:
        """Test SDTargetingRecommendationsRequestV32
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SDTargetingRecommendationsRequestV32`
        """
        model = SDTargetingRecommendationsRequestV32()
        if include_optional:
            return SDTargetingRecommendationsRequestV32(
                tactic = 'T00020',
                products = [
    ...
    def testSDTargetingRecommendationsRequestV32(self):
        """Test SDTargetingRecommendationsRequestV32"""
