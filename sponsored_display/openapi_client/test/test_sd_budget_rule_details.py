...
class TestSDBudgetRuleDetails(unittest.TestCase):
    """SDBudgetRuleDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SDBudgetRuleDetails:
        """Test SDBudgetRuleDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SDBudgetRuleDetails`
        """
        model = SDBudgetRuleDetails()
        if include_optional:
            return SDBudgetRuleDetails(
    ...
    def testSDBudgetRuleDetails(self):
        """Test SDBudgetRuleDetails"""
